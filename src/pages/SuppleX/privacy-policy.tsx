...
const Privacy = () => {
  return (
    <main className="w-full bg-primary-light dark:bg-primary-dark flex flex-col items-center justify-center overflow-hidden sm:h-full pt-20 pb-40">
      <div></div>
      <div className="flex items-center md:justify-evenly md:max-w-[60rem] flex-col md:flex-row-reverse w-full">
        <div className="mt-10 md:mt-10 max-w-[17rem] sm:max-w-[80rem] sm:ml-10">
          <h1 className="w-full md:mt-0 text-3xl sm:text-5xl text-primary-dark dark:text-primary-light">SuppleX - Privacy Policy</h1>
          <p className='mt-10'>Updated at 2024-11-03</p>

          <p className='mt-10'>SuppleX (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by SuppleX.</p>
          <p className='mt-5'>This Privacy Policy applies to our website, and its associated subdomains (collectively, our &quot;Service&quot;) alongside our application, SuppleX. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.</p>

          <h1 className="w-full md:mt-0 text-2xl sm:text-2xl text-primary-dark dark:text-primary-light pt-10 pb-2">Definitions and key terms</h1>
          ...
          <ul>
            <li className='mt-3'>Cookie: small amount of data generated by a website and saved by your web browser. It is used to identify your browser, provide analytics, remember information about you such as your language preference or login information.</li>
            <li className='mt-3'>Company: when this policy mentions &quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our,&quot; it refers to SuppleX, that is responsible for your information under this Privacy Policy.</li>
            <li className='mt-3'>Country: where SuppleX or the owners/founders of SuppleX are based, in this case is Sweden</li>
            <li className='mt-3'>Customer: refers to the company, organization or person that signs up to use the SuppleX Service to manage the relationships with your consumers or service users.</li>
            <li className='mt-3'>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit SuppleX and use the services.</li>
            <li className='mt-3'>IP address: Every device connected to the Internet is assigned a number known as an Internet protocol (IP) address. These numbers are usually assigned in geographic blocks. An IP address can often be used to identify the location from which a device is connecting to the Internet.</li>
            <li className='mt-3'>Personnel: refers to those individuals who are employed by SuppleX or are under contract to perform a service on behalf of one of the parties.</li>
          ...
          <h1 className="w-full md:mt-0 text-2xl sm:text-2xl text-primary-dark dark:text-primary-light pt-10 pb-2">Information automatically collected</h1>
          ...
          <h1 className="w-full md:mt-0 text-2xl sm:text-2xl text-primary-dark dark:text-primary-light pt-10 pb-2">Sale of Business</h1>
          <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of SuppleX or any of its Corporate Affiliates (as defined herein), or that portion of SuppleX or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

          <h1 className="w-full md:mt-0 text-2xl sm:text-2xl text-primary-dark dark:text-primary-light pt-10 pb-2">Affiliates</h1>
          <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, &quot;Corporate Affiliate&quot; means any person or entity which directly or indirectly controls, is controlled by or is under common control with SuppleX, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>

          <h1 className="w-full md:mt-0 text-2xl sm:text-2xl text-primary-dark dark:text-primary-light pt-10 pb-2">Governing Law</h1>
          ...
          <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by SuppleX. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
          <h1 className="w-full md:mt-0 text-2xl sm:text-2xl text-primary-dark dark:text-primary-light pt-10 pb-2">Cookies</h1>
          ...
          <ul><li>Local Storage
              ...
              <h1 className="w-full md:mt-0 text-2xl sm:text-2xl text-primary-dark dark:text-primary-light pt-10 pb-2">Information about General Data Protection Regulation (GDPR)</h1>
              ...
              <ul>
              <li className='mt-3'>Personal data collected must be processed in a fair, legal, and transparent way and should only be used in a way that a person would reasonably expect.</li>
              <li className='mt-3'>Personal data should only be collected to fulfil a specific purpose and it should only be used for that purpose. Organizations must specify why they need the personal data when they collect it.</li>
              <li className='mt-3'>Personal data should be held no longer than necessary to fulfil its purpose.</li>
              <li className='mt-3'>People covered by the GDPR have the right to access their own personal data. They can also request a copy of their data, and that their data be updated, deleted, restricted, or moved to another organization.</li>
              </ul>
              ...
              <h1 className="w-full md:mt-0 text-2xl sm:text-2xl text-primary-dark dark:text-primary-light pt-10 pb-2">California Online Privacy Protection Act (CalOPPA)</h1>
